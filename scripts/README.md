...
## Prepare Gaussian Input Files for Scanning Proton Donor-Acceptor Distance
...
The following arguments are required (the script no longer prompts interactively for missing indices):
...
## Prepare Gaussian Input Files for Scanning Proton Potential at each R
