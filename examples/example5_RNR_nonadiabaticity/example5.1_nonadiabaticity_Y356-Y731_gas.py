...
plt.fill_between(rp, shifted_Evib_reactant[0] + scale_wfc * sign * wfc_reactant[0], shifted_Evib_reactant[0], color='b',
                 alpha=0.4)
...
plt.fill_between(rp, shifted_Evib_product[0] + scale_wfc * sign * wfc_product[0], shifted_Evib_product[0], color='r',
                 alpha=0.4)
